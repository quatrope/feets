...
def features_table():
    rows = []
    for feature in extractor_registry.registered_features:
        ext = extractor_registry.extractor_of(feature)
        if "Freq1_harmonics_amplitude_0" in ext.get_features():
            continue
    ...
    FourierComponents = extractor_registry.extractor_of(
