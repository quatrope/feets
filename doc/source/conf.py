# -*- coding: utf-8 -*-
#
# feets documentation build configuration file, created by
# sphinx-quickstart on Mon Aug 14 03:01:18 2017.
#
...
latex_documents = [
    (master_doc, 'feets.tex', u'feets Documentation',
     u'JuanBC', 'manual'),
]
...
man_pages = [
    (master_doc, 'feets', u'feets Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'feets', u'feets Documentation',
     author, 'feets', 'One line description of project.',
     'Miscellaneous'),
]
