...
from feets.extractors.light_curve.ext_weighted_mean import WeightedMean
...
def test_WeightedMean_extract(normal):
    # init extractor
    extractor = WeightedMean()
    ...
    expected = pd.Series({"WeightedMean": -0.0000761351639945737})
