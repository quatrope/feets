...
from feets.extractors.light_curve.ext_excess_variance import ExcessVariance
...
def test_ExcessVariance_extract(normal):
    # init extractor
    extractor = ExcessVariance()
    ...
    expected = pd.Series({"ExcessVariance": -802615.69754577})
