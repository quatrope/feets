...
from feets.extractors.light_curve.ext_anderson_darling import AndersonDarling
...
def test_AndersonDarling_extract(normal):
    # init extractor
    extractor = AndersonDarling()
    ...
    expected = pd.Series({"AndersonDarling": 0.37753063})
