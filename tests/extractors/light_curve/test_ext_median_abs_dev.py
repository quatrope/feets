...
from feets.extractors.light_curve.ext_median_abs_dev import MedianAbsDev
...
def test_MedianAbsDev_extract(normal):
    # init extractor
    extractor = MedianAbsDev()
    ...
    expected = pd.Series({"MedianAbsDev": 0.6735277130207087})
