...
from feets.extractors.light_curve.ext_percent_diff_percentile import (
...
def test_PercentDiffPercentile_extract(uniform):
    extractor = PercentDiffPercentile()
    ...
    expected = 1.8006518831938725  # PercentDiffPercentile_5
