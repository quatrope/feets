...
from feets.extractors.light_curve.ext_percent_amplitude import PercentAmplitude
...
def test_PercentAmplitude_extract(uniform):
    # init extractor
    extractor = PercentAmplitude()
    ...
    expected = pd.Series({"PercentAmplitude": 0.5112194429289778})
