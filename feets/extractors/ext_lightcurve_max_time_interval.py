...
class Lightcurve_MaximumTimeInterval(Extractor):
    features = [
        "lightcurve_MaximumTimeInterval",
    ]
    ...
    def extract(self, time):
        ...
        feature = MaximumTimeInterval(**self.lightcurve_kwds)

        [result] = feature(time, magnitude)

        return {
            "lightcurve_MaximumTimeInterval": result,
        }
