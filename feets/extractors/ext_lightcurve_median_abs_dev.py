...
class Lightcurve_MedianAbsoluteDeviation(Extractor):
    features = [
        "lightcurve_MedianAbsoluteDeviation",
    ]
    ...
    def extract(self, magnitude):
        ...
        feature = MedianAbsoluteDeviation(**self.lightcurve_kwds)

        [result] = feature(time, magnitude)

        return {
            "lightcurve_MedianAbsoluteDeviation": result,
        }
