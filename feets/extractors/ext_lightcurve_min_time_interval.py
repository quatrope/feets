...
class Lightcurve_MinimumTimeInterval(Extractor):
    features = [
        "lightcurve_MinimumTimeInterval",
    ]
    ...
    def extract(self, time):
        ...
        feature = MinimumTimeInterval(**self.lightcurve_kwds)

        [result] = feature(time, magnitude)

        return {
            "lightcurve_MinimumTimeInterval": result,
        }
